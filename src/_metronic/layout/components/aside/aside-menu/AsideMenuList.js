  ...
  return (
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        >
          <NavLink className="menu-link menu-toggle" to="/admin/orders">
            <span className="svg-icon menu-icon">
            ...
            <ul className="menu-subnav">
              <ul className="menu-subnav">
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/supplier">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/othermanager">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Quản lý khác</span>
                  </NavLink>
                </li>
        ...
        {/* <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/product">
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/supplier">

            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/Box2.svg")} />
            </span>
            <span className="menu-text">Quản lý nhà cung cấp</span>
        ...
        <li
          className={`menu-item menu-item-submenu ${getMenuItemActive(
            "/admin/othermanager", true
          )}`}
          aria-haspopup="true"
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/othermanager">
            ...
            <ul className="menu-subnav">
              <ul className="menu-subnav">
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/orders/retail">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Đơn lẻ</span>
                  </NavLink>
                </li>
                <li
                  className={`menu-item ${getMenuItemActive(
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/orders/wholesale">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Đơn sỉ</span>
                  </NavLink>
                </li>
                <li
                  className={`menu-item ${getMenuItemActive(
                    "/admin/orders/auction"
                  )}`}
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/orders/auction">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Đơn đấu giá</span>
                  </NavLink>
                </li>
                <li
                  className={`menu-item ${getMenuItemActive(
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/orders/shipment">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Đơn vận chuyển hộ</span>
                  </NavLink>
                </li>
                <li
                  className={`menu-item ${getMenuItemActive(
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/orders/payment">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Đơn thanh toán hộ</span>
                  </NavLink>
                </li>
                {/*end::2 Level*/}
        ...
        <li
            ...
            data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/purchase">

            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/Box3.svg")} />
            </span>
            <span className="menu-text">Đơn mua hàng</span>
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/transaction">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/Box2.svg")} />
            </span>
            ...
            <ul className="menu-subnav">
              <ul className="menu-subnav">
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/transaction">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/transaction-type">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Loại giao dịch</span>
                  </NavLink>
                </li>
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/manage-user">
            <span className="svg-icon menu-icon">
            ...
            <ul className="menu-subnav">
              <ul className="menu-subnav">
                ...
                <li
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/warehouse">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">SFA</span>
                  </NavLink>
                </li>
                <li
                  className={`menu-item ${getMenuItemActive(
                  ...
                  aria-haspopup="true"
                >
                  <NavLink className="menu-link" to="/admin/box">
                    <i className="menu-bullet menu-bullet-dot">
                      <span />
                    </i>
                    <span className="menu-text">Thùng hàng</span>
                  </NavLink>
                </li>
                    ...
                    <ul className="menu-subnav">
                      <ul className="menu-subnav">
                        ...
                        <li
                          ...
                          aria-haspopup="true"
                        >
                          <NavLink className="menu-link" to="/admin/agency">
                            <i className="menu-bullet menu-bullet-dot">
                              <span />
                            </i>
                            <span className="menu-text">Đại lý kho</span>
                          </NavLink>
                        </li>
                        <li
                          className={`menu-item ${getMenuItemActive(
                            "/admin/shipmentmethod"
                          )}`}
                          aria-haspopup="true"
                        >
                          <NavLink className="menu-link" to="/admin/shipmentmethod">
                            <i className="menu-bullet menu-bullet-dot">
                              <span />
                            </i>
                            <span className="menu-text">Phương thức vận chuyển</span>
                          </NavLink>
                        </li>
                        <li
                          className={`menu-item ${getMenuItemActive(
                          ...
                          aria-haspopup="true"
                        >
                          <NavLink className="menu-link" to="/admin/shelve">
                            <i className="menu-bullet menu-bullet-dot">
                              <span />
                            </i>
                            <span className="menu-text">Kệ hàng</span>
                          </NavLink>
                        </li>
                        <li
                          className={`menu-item ${getMenuItemActive(
                          ...
                          aria-haspopup="true"
                        >
                          <NavLink className="menu-link" to="/admin/pallet">
                            <i className="menu-bullet menu-bullet-dot">
                              <span />
                            </i>
                            <span className="menu-text">Đế chứa hàng</span>
                          </NavLink>
                        </li>
        ...
        {/* <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/warehouse">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Home/Home.svg")} />
            </span>
<<<<<<< HEAD
            <span className="menu-text">Quản lý SFA</span>
=======
            <span className="menu-text">Quản lý SFA </span>
>>>>>>> dev.warehouses
          </NavLink>
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/admin/box">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Home/Box.svg")} />
            </span>
            <span className="menu-text">Quản lý thùng hàng</span>
          </NavLink>
        </li> */}
